...
function BPView() {
    ...
    return (
        <div className="select-none rounded-md border-solid border-2 border-sky-500 mb-6 p-4 bg-white dark:bg-slate-900 dark:border-slate-800 grow relative flex flex-row">
