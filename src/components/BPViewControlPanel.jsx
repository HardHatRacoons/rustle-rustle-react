...
function BPViewControlPanel({ pdfInfo }) {
    return (
        <div className="shadow-lg rounded-md border-2 border-slate-400 dark:border-slate-700 dark:bg-slate-800 flex flex-col h-full w-[300px] p-4">
            ...
            <div className="grid grid-cols-2 gap-4 p-4 max-w-sm">
                <a
                    ...
                    className={`border-2 border-slate-400 rounded-md p-4 flex flex-col items-center justify-center col-span-2 
                        ${!pdfInfo.url.annotated.pdf ? 'bg-gray-300 dark:bg-slate-500 dark:text-slate-400' : 'dark:text-slate-300 bg-sky-300 dark:bg-sky-800 hover:bg-sky-400 dark:hover:bg-sky-700'}`}
                >
                ...
                <a
                    ...
                    className={`border-2 border-slate-400 rounded-md p-4 flex flex-col items-center justify-center 
                        ${!pdfInfo.url.annotated.csv ? 'bg-gray-200 dark:bg-slate-500 text-white-700 dark:text-slate-400' : 'dark:text-slate-300 bg-green-200 dark:bg-green-700 hover:bg-green-30 dark:hover:bg-green-600 text-gray-700'}`}
                >
                ...
                <a
                    ...
                    target="_blank"
                    className="border-2 border-slate-400 text-gray-700 dark:text-slate-300 rounded-md p-4 flex flex-col items-center justify-center 
