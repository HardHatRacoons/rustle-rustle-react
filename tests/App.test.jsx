...
//     );
    ...
    vi.mock(import("aws-amplify/storage"), async (importOriginal) => {
          ...
          return {
            ...actual,
            getUrl: vi.fn().mockResolvedValue({url: new URL("https://fake-pdf-endpoint")}),
          }
    });
  ...
  test('can move to blueprint page', () => {
    render(
